package com.twentyfourcalendar.watchface.watchface
...
import com.twentyfourcalendar.watchface.R
import com.twentyfourcalendar.watchface.data.model.DailySnapshot
import com.twentyfourcalendar.watchface.data.model.Event
import com.twentyfourcalendar.watchface.data.model.SleepData
import com.twentyfourcalendar.watchface.data.model.Task
import com.twentyfourcalendar.watchface.data.repository.SnapshotRepository
import com.twentyfourcalendar.watchface.data.util.IntervalMinutes
import com.twentyfourcalendar.watchface.data.util.angleForInstantPrecise
import com.twentyfourcalendar.watchface.data.util.angleForMinutes
import com.twentyfourcalendar.watchface.data.util.angleFromTouch
import com.twentyfourcalendar.watchface.data.util.assignLayers
import com.twentyfourcalendar.watchface.data.util.backToBackMarkers
import com.twentyfourcalendar.watchface.data.util.isAngleWithinArc
import com.twentyfourcalendar.watchface.data.util.minutesSinceMidnight
...
class TimelineCanvasRenderer(
    ...
    private fun drawCountdownOnIndicator(
        ...
        // Flip text from 7pm (15°) to 4am (150°)
        val normalizedAngle = ((currentTimeAngle % 360f) + 360f) % 360f
        val flipped = normalizedAngle >= 15f && normalizedAngle <= 150f
    ...
    private fun drawEventPopup(
        ...
        val gap = 5f
        val arrowSize = outerRadius * 0.05f
    ...
    private fun drawSelectedEventDescription(
        ...
        // Flip from 7pm (15°) to 4am (150°) — same rule as countdown indicator
        val flipped = normalizedMid >= 15f && normalizedMid <= 150f

        val titlePaint = Paint().apply {
            isAntiAlias = true
            color = 0xFF00AAFF.toInt()
            textSize = outerRadius * 0.13f
            textAlign = Paint.Align.CENTER
